...
import { createCoreStore } from '../runtime/core-store.mjs';
import { createMemoryClientFromEnv } from '../runtime/memory-client.mjs';
import { createOrchestrator } from '../runtime/orchestrator.mjs';

const core = await createOrchestrator({ memoryClient: createMemoryClientFromEnv(), eventStore: createCoreStore() });
